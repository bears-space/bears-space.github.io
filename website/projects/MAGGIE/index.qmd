...
More informations about the X-Tutorials for on the [BUA-Website](https://www.berlin-university-alliance.de/commitments/teaching-learning/sturop/tutorials/archiv/sem_aktuell/MAGGIE/index.html).
...
::: {layout-ncol=2}
![](images/BUA_Logo_hoch_3_RGB_24.png){fig-alt="BUA Logo" width=40%}
![](images/TU_BERLIN_Logo_Lang_RGB_SR_rot.png){fig-alt="TUB Logo" width=40%}
:::
