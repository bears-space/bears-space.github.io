...
| `description` | string | Caption shown when this slide appears on /media. Use it for any combination of caption and photographer credit. No effect on the homepage hero. |
