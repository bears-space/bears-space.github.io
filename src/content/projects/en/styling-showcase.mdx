...
<Button content="Standard Primary" variant="primary" size="standard" href="#buttons" />

<Button content="Large Primary Button" variant="primary" size="large" />

### Secondary Buttons

<Button content="Standard Secondary" variant="secondary" size="standard" />

<Button content="Large Secondary" variant="secondary" size="large" />

### Inverse Buttons

<Button content="Standard Inverse" variant="inverse" size="standard" />

<Button content="Large Inverse Button" variant="inverse" size="large" />
...
### Full Width Image
<Img src="/src/assets/projects/erc-rover/Rover_team.jpg" alt="Full width project showcase" width="100%" />

### 80% Width Image
<Img src="/src/assets/projects/erc-rover/Rover_all_groups.jpg" alt="80% width image" width="80%" />

### 60% Width Image
<Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="60% width image" width="60%" />
...
<ImageGrid
  ...
  aspectRatio='square'
  images={[
    { image: "/src/assets/projects/erc-rover/Rover_team.jpg", alt: "Project 1 grid example" },
    { image: "/src/assets/projects/erc-rover/Rover_all_groups.jpg", alt: "Project 2 grid example" },
    { image: "/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg", alt: "Project 3 grid example" },
    { image: "/src/assets/projects/erc-rover/Rover_robro.jpg", alt: "Project 4 grid example" },
    { image: "/src/assets/projects/erc-rover/Rover_tag.jpg", alt: "Project 5 grid example" },
    { image: "/src/assets/projects/erc-rover/Rover_team_with_erc_banner.jpg", alt: "Project 6 grid example" }
  ]}
/>
...
<Carousel showArrows={true} showDots={true} height="md">
  <Img src="/src/assets/projects/erc-rover/Rover_team.jpg" alt="Project 1" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_all_groups.jpg" alt="Project 2" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="Project 3" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_robro.jpg" alt="Project 4" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_tag.jpg" alt="Project 5" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_team_with_erc_banner.jpg" alt="Project 6" class="rounded-lg" />
</Carousel>
...
<Marquee speed={80} gap="1.5rem" height="md" direction='left'>
  <Img src="/src/assets/projects/erc-rover/Rover_team.jpg" alt="Project 1 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_all_groups.jpg" alt="Project 2 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="Project 3 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_robro.jpg" alt="Project 4 showcase" class="rounded-lg" />
</Marquee>
...
<Marquee speed={180} gap="2rem" height="sm" direction="right">
  ...
  <Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="Project 3 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_robro.jpg" alt="Project 4 showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_tag.jpg" alt="Project 5 showcase" class="rounded-lg" />
</Marquee>
  ...
  items={[
    {
      ...
      content: "This marquee showcases featured projects with smooth scrolling animation. Hover to pause."
    },
    {
      title: "Component Benefits",
      content: "These components create engaging, interactive user experiences that keep visitors engaged."
    }
  ]}
  mode="single-closed"
  width="100%"
...
<Button content="See Color in Action" variant="primary" size="standard" />
