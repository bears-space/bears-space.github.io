...
<Button content="Standard Primär" variant="primary" size="standard" href="#buttons" />

<Button content="Großer Primärer Button" variant="primary" size="large" />

### Sekundäre Buttons

<Button content="Standard Sekundär" variant="secondary" size="standard" />

<Button content="Großer Sekundärer Button" variant="secondary" size="large" />

### Inverse Buttons

<Button content="Standard Invers" variant="inverse" size="standard" />

<Button content="Großer Inverser Button" variant="inverse" size="large" />
...
<Img src="/src/assets/projects/erc-rover/Rover_team.jpg" alt="Projektpräsentation in voller Breite" width="100%" />

### Bild mit 80% Breite
<Img src="/src/assets/projects/erc-rover/Rover_all_groups.jpg" alt="Bild mit 80% Breite" width="80%" />

### Bild mit 60% Breite
<Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="Bild mit 60% Breite" width="60%" />
...
<ImageGrid
  ...
  aspectRatio='square'
  images={[
    { image: "/src/assets/projects/erc-rover/Rover_team.jpg", alt: "Projekt 1 Rasterbeispiel" },
    { image: "/src/assets/projects/erc-rover/Rover_all_groups.jpg", alt: "Projekt 2 Rasterbeispiel" },
    { image: "/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg", alt: "Projekt 3 Rasterbeispiel" },
    { image: "/src/assets/projects/erc-rover/Rover_robro.jpg", alt: "Projekt 4 Rasterbeispiel" },
    { image: "/src/assets/projects/erc-rover/Rover_tag.jpg", alt: "Projekt 5 Rasterbeispiel" },
    { image: "/src/assets/projects/erc-rover/Rover_team_with_erc_banner.jpg", alt: "Projekt 6 Rasterbeispiel" }
  ]}
/>
...
<Carousel showArrows={true} showDots={true} height="md">
  <Img src="/src/assets/projects/erc-rover/Rover_team.jpg" alt="Projekt 1" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_all_groups.jpg" alt="Projekt 2" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="Projekt 3" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_robro.jpg" alt="Projekt 4" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_tag.jpg" alt="Projekt 5" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_team_with_erc_banner.jpg" alt="Projekt 6" class="rounded-lg" />
</Carousel>
...
<Marquee speed={80} gap="1.5rem" height="md" direction='left'>
  <Img src="/src/assets/projects/erc-rover/Rover_team.jpg" alt="Projekt 1 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_all_groups.jpg" alt="Projekt 2 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="Projekt 3 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_robro.jpg" alt="Projekt 4 Showcase" class="rounded-lg" />
</Marquee>
...
<Marquee speed={180} gap="2rem" height="sm" direction="right">
  ...
  <Img src="/src/assets/projects/erc-rover/Rover_fixing_onsite.jpg" alt="Projekt 3 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_robro.jpg" alt="Projekt 4 Showcase" class="rounded-lg" />
  <Img src="/src/assets/projects/erc-rover/Rover_tag.jpg" alt="Projekt 5 Showcase" class="rounded-lg" />
</Marquee>
  ...
  items={[
    {
      ...
      content: "Dieses Marquee zeigt ausgewählte Projekte mit flüssiger Scroll-Animation. Hover zum Pausieren."
    },
    {
      title: "Komponenten-Vorteile",
      content: "Diese Komponenten schaffen ansprechende, interaktive Nutzererlebnisse, die Besucher fesseln."
    }
  ]}
  mode="single-closed"
  width="100%"
...
<Button content="Farbe in Aktion sehen" variant="primary" size="standard" />
